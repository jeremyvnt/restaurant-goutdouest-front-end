                  ...
                  (e = (function (t, e) {
                    return new Promise(function (r, n) {
                      ((e = document.createElement("script")).onload = r),
                        (e.onerror = function () {
                          return n(
                            u(new Error("Failed to load script: ".concat(t)))
                          );
                        }),
                ...
                f(t, r)
                  .then(function (t) {
                    var n = t.scripts,
                      o = t.css;
                    return Promise.all([
                      e.has(r) ? [] : Promise.all(n.map(l)),
                      Promise.all(o.map(h)),
                    ]);
                  })
                  .then(function (t) {
                    return o.whenEntrypoint(r).then(function (e) {
                      return { entrypoint: e, styles: t[1] };
                    });
                  }),
                3800,
                u(new Error("Route did not complete loading: ".concat(r)))
              )
                .then(function (t) {
                  var e = t.entrypoint,
                    r = t.styles,
                    n = Object.assign({ styles: r }, e);
    ...
    1689: function (t, e, r) {
      ...
      function N(t, e) {
        return fetch(t, { credentials: "same-origin" }).then(function (r) {
          if (!r.ok) {
            if (e > 1 && r.status >= 500) return N(t, e - 1);
            if (404 === r.status)
      ...
      function M(t, e) {
        return N(t, e ? 3 : 1).catch(function (t) {
        ...
        return (
          i(t, [
                          ...
                          switch ((e.prev = e.next)) {
                            ...
                            case 50:
                              if (
                                ...
                                (D = (0, u.removePathTrailingSlash)(P)),
                                R(a))
                              ) {
                                e.next = 60;
                                break;
                            ...
                            case 80:
                              ...
                              if (
                                (((tt = (0, d.parseRelativeUrl)(
                                  Z
                                )).pathname = A(tt.pathname, j)),
                            ...
                            case 114:
                              ...
                              throw (
                                (t.events.emit("routeChangeError", X, w, y), X)
                              );
                            case 117:
                              return (
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 24:
                              return (
                                (t.next = 26),
                                Promise.all([
                                  this.pageLoader._isSsg(v).then(function (t) {
                                    return (
                                      !!t &&
                                      m._getStaticData(
            ...
            },
            {
              ...
              value: function (e, r) {
                this.clc &&
                  (t.events.emit("routeChangeError", _(), e, r),
                  this.clc(),
                  (this.clc = null));
              },
            },
